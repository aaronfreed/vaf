...
- [A more detailed overview of Vasara 2’s new features and settings](#new-features--planned-additions):
...
4. *(Optional, but highly recommended.)* Set it up in Weland. There are brief instructions in Weland’s readme; should one of the steps prove challenging or frustrating, I’ve written detailed guides for doing this on Windows and MacOS. If the word “Forge” means anything to you in a *Marathon* context, you’ll probably want [my advanced guide](https://aaronfreed.github.io/mapmaking.html#welandsetup); otherwise, you should probably consult my [beginners’ guide](https://aaronfreed.github.io/mapmaking101.html#welandsetup). (One of these days I’ll write a guide for Linux.)
...
#### Apply texture mode
Vasara 2.0b splits “Apply texture mode” and “apply texture” into two separate options.
...
Vasara 2.0b lists what you’re looking at in the upper-left corner of visual mode, including one feature you’re probably not familiar with: ambient delta.
...
- Vasara 2.0b is, of course, based on **[Vasara 1.0.3](https://simplici7y.com/items/vasara)** by **[@Hopper262](https://github.com/Hopper262)** (Jeremiah Morris, who did most of the programming) and **Ares Ex Machina** (who did most of the UI design).
...
--**Aaron**, 2023-12-12 (last edited 2024-03-18)
